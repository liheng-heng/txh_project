...
public class OkHttpDownloadRequest extends OkHttpGetRequest {
    ...
    protected OkHttpDownloadRequest(String url, Object tag, Map<String, String> params, Map<String, String> headers, String destFileName, String destFileDir) {
