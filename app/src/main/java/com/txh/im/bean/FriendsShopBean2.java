...
public class FriendsShopBean2 {
    ...
    private HomeSingleListBean Item;
    ...
    public HomeSingleListBean getItem() {
        return Item;
    }

    public void setItem(HomeSingleListBean item) {
        Item = item;
    }

    @Override
    public String toString() {
        return "FriendsShopBean2{" +
                "UnitId='" + UnitId + '\'' +
                ", UnitType='" + UnitType + '\'' +
                ", IsTrue='" + IsTrue + '\'' +
                ", UnitName='" + UnitName + '\'' +
