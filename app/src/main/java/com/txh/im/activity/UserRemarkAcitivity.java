...
public class UserRemarkAcitivity extends BasicActivity {
...
//                            toast(basebean.getMsg());
    ...
    private void finishCurrent() {
        ...
        new GetNetUtil(map, Api.TX_App_SNS_GetFriendDetail, UserRemarkAcitivity.this) {
            @Override
            public void successHandle(String base) {
                if (isDestroy) {
                    return;
                ...
                if (basebean.getStatus().equals("200")) {
                    Intent intent = new Intent(UserRemarkAcitivity.this, FriendsDataAddActivity.class);
    ...
    private void fromChatFinishCurrent() {
        final HashMap<String, String> map = new HashMap<>();
        map.put("MsgUserId", friendId);
        new GetNetUtil(map, Api.TX_App_SNS_GetMessageUser, UserRemarkAcitivity.this) {
            @Override
            public void successHandle(String base) {
                if (isDestroy) {
                    return;
                ...
                if (basebean.getStatus().equals("200")) {
                    ...
                    UserRemarkAcitivity.this.startActivity(intent);
                    finish();
                } else {
                    toast(basebean.getMsg());
                    isChecked = false;
