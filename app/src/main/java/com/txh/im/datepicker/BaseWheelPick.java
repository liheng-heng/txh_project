...
import com.txh.im.R;
import com.txh.im.datepicker.genview.GenWheelText;
import com.txh.im.datepicker.genview.WheelGeneralAdapter;
import com.txh.im.datepicker.view.OnWheelChangedListener;
import com.txh.im.datepicker.view.OnWheelScrollListener;
import com.txh.im.datepicker.view.WheelView;
...
abstract class BaseWheelPick extends LinearLayout implements OnWheelChangedListener, OnWheelScrollListener {
    ...
    protected int textColor = 0xff999999;
    protected int selectColor = 0xff666666;
