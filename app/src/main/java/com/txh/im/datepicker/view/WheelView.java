...
package com.txh.im.datepicker.view;
...
import com.txh.im.R;
import com.txh.im.datepicker.adapters.WheelViewAdapter;
...
public class WheelView extends View {
    ...
    private void refreshTextStatus(View oldView, int old) {
        ...
        textview.setPadding(0, dip2px(getContext(),2), 0, dip2px(getContext(),2));//left, top, right, bottom
