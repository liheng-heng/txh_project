...
public class SearchHistoryBeanDao extends AbstractDao<SearchHistoryBean, Long> {
    ...
    public static class Properties {
        ...
        public final static Property LocatinUsername = new Property(2, String.class, "locatinUsername", false, "LOCATIN_USERNAME");
    }
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"SEARCH_HISTORY_BEAN\" (" + //
                ...
                "\"LOCATIN_USERNAME\" TEXT);"); // 2: locatinUsername
    }
    ...
    protected final void bindValues(DatabaseStatement stmt, SearchHistoryBean entity) {
        ...
        String locatinUsername = entity.getLocatinUsername();
        if (locatinUsername != null) {
            stmt.bindString(3, locatinUsername);
        }
    }
    ...
    public SearchHistoryBean readEntity(Cursor cursor, int offset) {
        SearchHistoryBean entity = new SearchHistoryBean( //
            ...
            cursor.isNull(offset + 2) ? null : cursor.getString(offset + 2) // locatinUsername
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, SearchHistoryBean entity, int offset) {
        ...
        entity.setLocatinUsername(cursor.isNull(offset + 2) ? null : cursor.getString(offset + 2));
     }
