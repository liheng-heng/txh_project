...
import com.txh.im.listener.OnItemClickListener;
        ...
        switch (e.getAction()) {
            case MotionEvent.ACTION_DOWN:
                if (mDeleteBtnState == 0) {
                    ...
                    HomeListAdapter.ViewHolder viewHolder = (HomeListAdapter.ViewHolder) getChildViewHolder(view);
                    mItemLayout = viewHolder.rlConversationItem;
                    llClick = viewHolder.llClick;
                    rlClick = viewHolder.rlClick;
...
//                    mDelete = (TextView) mItemLayout.findViewById(R.id.tv_item_delete);
            ...
            case MotionEvent.ACTION_UP:
                if (!isItemMoving && !isDragging && mListener != null) {
                            mListener.onItemClick(llClick, mPosition);
                }
                isItemMoving = false;
