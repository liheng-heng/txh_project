 ...
 */
package com.txh.im.easeui.utils;
...
//        return mSharedPreferences.getBoolean(SHARED_KEY_SETTING_NOTIFICATION, false);//关闭声音,jiajia
        return mSharedPreferences.getBoolean(SHARED_KEY_SETTING_NOTIFICATION, true);
    }

    public void setSettingMsgSound(boolean paramBoolean) {
//        editor.putBoolean(SHARED_KEY_SETTING_SOUND, false);//关闭声音,jiajia
    ...
    public String getCurrentUserAvatar() {//用户自己的头像
//		return mSharedPreferences.getString(SHARED_KEY_CURRENTUSER_AVATAR, null);
        return GlobalApplication.getInstance().getPerson(GlobalApplication.getInstance().getApplicationContext()).getImagesHead();
    }
