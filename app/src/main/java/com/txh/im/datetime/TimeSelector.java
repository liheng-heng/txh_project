...
public class TimeSelector {
    ...
    private void initDialog() {
        if (seletorDialog == null) {
            ...
            seletorDialog.setContentView(R.layout.date_dialog_selector);
    ...
    private void loadComponent() {
        year_pv.setData(year, "1");
        month_pv.setData(month, "2");
        day_pv.setData(day, "3");
        hour_pv.setData(hour, "4");
        minute_pv.setData(minute, "5");
