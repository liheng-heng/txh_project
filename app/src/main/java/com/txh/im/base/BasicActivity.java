 ...
 */
public abstract class BasicActivity extends AppCompatActivity implements NetBroadcastReceiver.NetEvevt {
    ...
    public boolean inspectNet() {
        this.netMobile = NetUtil.getNetWorkState(BasicActivity.this);
        return isNetConnect();
