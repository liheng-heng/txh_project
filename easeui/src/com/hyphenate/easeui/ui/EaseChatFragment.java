...
public class EaseChatFragment extends EaseBaseFragment implements EMMessageListener {
    ...
    protected PullToRefreshLayout swipeRefreshLayout;//修改刷新样式,jiajia
    protected ListView listView;

    protected boolean isloading;
    protected boolean haveMoreData = true;
    //    protected int pagesize = 20;//默认加载20
    protected int pagesize = 10;//jiajia,需求要求加载10
...
//                R.color.holo_orange_light, R.color.holo_red_light);
    ...
    protected void setListItemClickListener() {
        messageList.setItemClickListener(new EaseChatMessageList.MessageListItemClickListener() {
            ...
            @Override
            public void onBubbleLongClick(EMMessage message, View bubbleLayout) {
                contextMenuMessage = message;
                if (chatFragmentHelper != null) {
                    chatFragmentHelper.onMessageBubbleLongClick(message, bubbleLayout);
                }
            }
    ...
    protected void setRefreshLayoutListener() {
        swipeRefreshLayout.setRefreshListener(new BaseRefreshListener() {
            @Override
            public void refresh() {
...
//                                    Toast.LENGTH_SHORT).show();
        ...
        swipeRefreshLayout.setCanLoadMore(false);//禁止加载更多
...
//        });
    ...
    public interface EaseChatFragmentHelper {
         ...
         */
        void onMessageBubbleLongClick(EMMessage message, View bubbleLayout);
